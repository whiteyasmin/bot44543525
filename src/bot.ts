...
const LEG1_STOP_LOSS  = 0;        // 止损已关闭
const LEG1_STOP_ABS   = 0;        // 止损已关闭
...
const TREND_STOP_LOSS_BID = 0;             // 止损已关闭
const TREND_RELATIVE_STOP_LOSS = 0;        // 止损已关闭
...
const THIN_EDGE_STOP_LOSS = 0;               // 止损已关闭
...
const DUAL_SIDE_MAX_ASK_PROTECTED = 0.35;  // 一直以0.35运行, 不受回撤保护影响
