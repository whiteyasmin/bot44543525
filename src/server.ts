...
const detailLabels = {
 ...
 bid:'买一', entryAvgPrice:'入场均价', profitCents:'浮盈 cents', elapsedSeconds:'持仓秒', hedgeSide:'对冲方向',
  ...
  pressureScore:'压力分', score:'信号分数', adversePressure:'反向压力', strongAdversePressure:'强反向压力', hedgeTimeOk:'剩余时间足够',
