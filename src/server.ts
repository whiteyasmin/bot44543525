...
<main>
  ...
  <section class="quick-panel"><h2>只填余额</h2><p class="hint">策略参数先保持默认，跑出正常 MD 和影子 MD 后再按数据调整。</p><form id="quickSettings" class="quick-settings single"></form><button id="saveQuick">保存余额</button></section>
  ...
  <details class="param-details"><summary>参数设置（一般不用）</summary><section class="param-panel"><h2>策略参数</h2><p class="hint">这些参数给回测后调整用，平时不要手动改。</p><div class="param-grid">
  ...
  </div><h2 class="advanced-title">高级参数</h2><form id="advancedSettings" class="settings"></form><button id="saveAdvanced">保存高级</button></section></details>
...
const detailLabels = {
 ...
 bid:'买一', entryAvgPrice:'入场均价', profitCents:'浮盈 cents', elapsedSeconds:'持仓秒', hedgeSide:'对冲方向',
  ...
  hedgeBlockReason:'未对冲原因', hedgeAsk:'对冲卖一', hedgeRatio:'动态对冲比例', hedgeCost:'对冲成本', unhedgedWorstLoss:'不对冲最坏亏损',
